...
export const Nubank = () => {
    return (
        <div className="flex flex-wrap place-items-center justify-between mt-6">
            ...
            <div className="flex items-center">
                ...
                <a className='text-blue-800' href='https://github.com/josueperezparejo' target="_blank">@josueperezparejo</a>
            </div>
